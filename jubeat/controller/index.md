...
Pinouts can be altered altered for the Pro Micro by changing the list to `{2,3,4,5,6,7,8,9,10,14,15,16,A0,A1,A2,A3}`. These I/O implementations assume that the switches for 1 button are routed in parallel, and that the board has pullup resistors built in. 
